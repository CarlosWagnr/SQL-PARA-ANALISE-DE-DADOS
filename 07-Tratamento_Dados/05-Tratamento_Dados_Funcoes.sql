-- FUNÇÕES - Servem para criar comandos personalizados de scripts usados recorrentemente.
...
select datediff('weeks', '2018-06-01', current_date); -- não existe esta função no PostgreSQL.
